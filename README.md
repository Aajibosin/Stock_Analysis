...
The biggest benefit that occurred as a result of the refactoring was an decrease in macro run time. The original analysis took approximately 0.87 to run, whereas our other analysis took a time about 0.88 seconds to run. 
